...
*Figure 5: Visual representation of the network core showing the trunk link between the Switch and the Router, enabling secure communication between VLAN 10 (Sales) and VLAN 20 (HR).*
